from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QLabel, QTextEdit,  QDesktopWidget, QMainWindow
...
class IngestionTool(QWidget):
    ...
    def open_settings(self):
        ...
        self.settings_window.setGeometry(0, 0, 800, 600)
    ...
    def open_config(self):
        ...
        self.config_window.setGeometry(0, 0, 800, 600)
