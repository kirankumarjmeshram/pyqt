...
input_folder = "C:\\Users\\Redmi\\Documents\\GitHub\\pyqt\\projects\\Injestion Tool"
...
class ConfigPage(QWidget):
    ...
    def browse_folder(self):
        ...
        self.input_path_input.setText(folder_path.replace("/", "\\"))
    ...
    def add_to_database(self):
        ...
        subprocess.run(["python", "preprocessing.py", "--input_folder", input_folder, "--backup_folder", backup_folder,
